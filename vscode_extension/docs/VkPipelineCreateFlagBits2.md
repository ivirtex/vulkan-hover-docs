# VkPipelineCreateFlagBits2(3) Manual Page
...
- `VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE` specifies that the pipeline **can** be used with layered fragment density maps.

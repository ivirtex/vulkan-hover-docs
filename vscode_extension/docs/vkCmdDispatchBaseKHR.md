...
vkCmdDispatchBase is affected by [conditional rendering](#drawing-conditional-rendering)
...
For more information, see the [Vulkan Specification](https://registry.khronos.org/vulkan/specs/latest/html/vkspec.html#vkCmdDispatchBase).
